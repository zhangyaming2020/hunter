...
class Qq {
    ...
    private $app_id ='101400732';

    private $app_secret ='a7b15aff72b6078ba4f7003d0de98ac6';    
...

    {
        ...
        return "https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id={$this->app_id}&redirect_uri={$redirect_uri}&state={$state}&display=mobile"; 

    }

    //pc端
    public function get_pc_authorize_url($redirect_uri = '')

    {
        ...
        return "https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id={$this->app_id}&redirect_uri={$redirect_uri}&state={$state}"; 
