...
class Weibo {
    ...
    private $app_id ='3036805506';

    private $app_secret ='cf53d7ac05aa6a593ad277da472fe33c';      
...
//		session('weibo',$state);
        ...
        return "https://open.weibo.cn/oauth2/authorize?client_id={$this->app_id}&response_type=code&redirect_uri={$redirect_uri}&state={$state}&display=mobile";    
