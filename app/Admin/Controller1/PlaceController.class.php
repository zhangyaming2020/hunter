...
class PlaceController extends AdminCoreController {
    ...
    public function index() {
        ...
        foreach($result as $r) {
            ...
            $r['str_manage'] = '<a href="javascript:;" data-uri="'.U('place/add',array('pid'=>$r['id'])).'" data-title="'.L('add_item_cate').'"   class="J_showdialog btn btn-xs btn-success btn-add" title="添加子分类" data-id="add" data-width="520" data-height="20"><i class="fa fa-plus"></i></a>
                                <a href="javascript:;" data-uri="'.U('place/edit',array('id'=>$r['id'])).'" data-title="'.L('edit').' - '. $r['name'] .'" data-id="edit" data-width="520" data-height="20" class="J_showdialog btn btn-xs btn-success btn-editone" title="'.L('edit').'"><i class="fa fa-pencil"></i></a>
                                <a href="javascript:;" data-acttype="ajax" data-uri="'.U('place/delete',array('id'=>$r['id'])).'" data-msg="'.sprintf(L('confirm_delete_one'),$r['name']).'" class="J_confirmurl btn btn-xs btn-danger btn-delone" title="'.L('delete').'"><i class="fa fa-trash"></i></a>';
