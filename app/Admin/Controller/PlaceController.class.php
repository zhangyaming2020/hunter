...
class PlaceController extends AdminCoreController {
    ...
    public function index() {
        ...
        foreach($result as $r) {
            ...
            $r['str_manage'] = '<a href="javascript:;" data-uri="'.U('place/add',array('pid'=>$r['id'])).'" data-title="'.L('add_item_cate').'"   class="J_showdialog" title="添加子分类" data-id="add" data-width="520" data-height="20">'.L('add_submenu').'</a>|
                                <a href="javascript:;" data-uri="'.U('place/edit',array('id'=>$r['id'])).'" data-title="'.L('edit').' - '. $r['name'] .'" data-id="edit" data-width="520" data-height="20" class="J_showdialog" title="'.L('edit').'">'.L('edit').'</a>|
                                <a href="javascript:;" data-acttype="ajax" data-uri="'.U('place/delete',array('id'=>$r['id'])).'" data-msg="'.sprintf(L('confirm_delete_one'),$r['name']).'" class="J_confirmurl" style="color:#F76741" title="'.L('delete').'">'.L('delete').'</a>';
    ...
    protected function _before_update($data) {
        ...
        $place = $this->_mod->field('pid')->where(array('id'=>$data['id']))->find();
