...
class MenuController extends AdminCoreController {
    ...
    public function index() {
        ...
        foreach($result as $r) {
            $r['cname'] = L($r['name']);
            $r['str_manage'] = '<a href="javascript:;" data-uri="'.U('menu/add',array('pid'=>$r['id'])).'" data-title="'.L('add_submenu').'" data-id="add" data-width="500" data-height="350" class="J_showdialog" title="添加子分类">'.L('add_submenu').'</a>
                                <a href="javascript:;" data-uri="'.U('menu/edit',array('id'=>$r['id'])).'" data-title="'.L('edit').' - '. $r['name'] .'" data-id="edit" data-width="500" data-height="350" class="J_showdialog" title="'.L('edit').'">'.L('edit').'</a>
                                <a href="javascript:;" data-acttype="ajax" data-uri="'.U('menu/delete',array('id'=>$r['id'])).'" data-msg="'.sprintf(L('confirm_delete_one'),$r['name']).'" class="J_confirmurl" title="'.L('delete').'">'.L('delete').'</a>';
