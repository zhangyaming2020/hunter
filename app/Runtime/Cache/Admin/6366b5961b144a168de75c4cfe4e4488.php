...
<div class="dialog_content">
	<div id="tabs">
		<form id="info_form" name="info_form" action="<?php echo U('project/add');?>" method="post">
			<input type="hidden" name="custom_id" id="prtaCustId" value="<?php echo ($custom_info["custom_id"]); ?>">
			<input type="hidden" name="prtaContactIds" id="prtaContactIds" value="0">
			<div id="tabs-1">
				<div class="form_default" style="padding:0; height:458px; OVERFLOW-Y: auto; BORDER: #ccc 1px solid;">
					<p>
						<label for="cutaName">项目名称</label>
						<input type="text" name="prtaName" id="prtaName" value="" class="sf" style="width:280px;">
						<select name="<?php echo ($dic[0]['field']); ?>" id="field">
							<option value="0"><?php echo ($dic[0]['name']); ?></option>
							<?php if(is_array($dic[0]['sub'])): $i = 0; $__LIST__ = $dic[0]['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>"><?php echo ($val["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
					...
					<p>
						...
						<input type="button" id="selectCustomerBtn" onclick="test()" class="button button_white" value="  <?php if($custom_info['cutaname']): echo ($custom_info["cutaname"]); else: ?> 选择客户..<?php endif; ?>">&nbsp;&nbsp;&nbsp;&nbsp;：<input type="button" id="selectCustomerContactBtn" class="button button_white" value="选择联系人.." style="max-width:300px;">
					</p>
					...
					<p>
						...
						<input type="text" name="prtaWorkCity" id="prtaWorkCity" class="sf" style="width:80px;" value="">
						...
						招聘人数&nbsp;&nbsp;<input type="text" name="prtaPositionNum" id="prtaPositionNum" class="sf" style="width:25px;" value="1">名
					</p>
					<p>
					...
					<p>
						<label>项目编号</label>
						<input type="text" name="prtaCode" id="prtaCode" value="" class="sf" style="width:180px;" maxlength="40">&nbsp;&nbsp;&nbsp;&nbsp;
						<span>
	                      <span>薪资福利&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<input type="text" name="prtaRemuneration" id="prtaRemuneration" value="" class="sf" style="width:180px;">
						</span>
					</p>
				</div>
