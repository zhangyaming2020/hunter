...
<title><?php echo L('website_manage');?></title>
	...
	var URL = '/hunter/jradmin.php/Resume';

	var SELF = '/hunter/jradmin.php?m=Admin&c=Resume&a=index&m=Admin&menuid=149&p=2';
...
<div class="left">
	...
	<a href="javascript:;" class="addNewButton" id="exportResumes">导出简历</a>

	<a href="javascript:;" class="addNewButton" id="addNewCopyButton">解析简历</a>
	<a href="javascript:;"   style="color:#fff;"    class="J_showdialog  addNewButton" data-uri="<?php echo U('Resume/add');?>" data-title="新增简历" data-id="add" data-editor="1" data-width="783" data-height="500">新增简历</a>
	...
	<a href="javascript:;"  class="dialog_open  addNewButton" style="color:#fff;"   data-uri="<?php echo U('Resume/import');?>" data-title="导入EXCEL表格" data-id="edit" data-width="480" data-editor="1" data-height="365" id="importResumes">导入EXCEL表格</a>
	<!--<a href="javascript:;" class="addNewButton" id="quickSearchResumeButton">临时查询窗口</a>-->
	<ul class="submenu" id="resumeTabs">

		<li class="current" dataid="1">
			<a href="javascript:;">所有简历</a>
		</li>

		<li id="resumeFavorite" class="select">
			<a href="javascript:;">简历收藏夹<span></span></a>
		</li>
	</ul>
	<div id="resumeFavoriteDiv" style="display:none; width:auto; min-width:280px; position: absolute; background: #f7f7f7; BORDER: #ccc 1px solid; z-index: 300;">
		<div style="padding:10px;">
			<input type="hidden" id="favoriteResuId" value="0">
			<input type="text" name="keyword" id="resumeFavoriteKeyword" value="" class="sf" style="width:120px;">&nbsp;<input type="button" id="searchFavorite" class="button button_white" value=" 查询 " style="height:30px;" onclick="searchFavorite()">&nbsp;<input type="button" id="createFavorite" class="button button_white" value="创建收藏夹" style="height:30px;">
		</div>
		<div id="resumeFavoriteResult"></div>
	</div>

	<div class="sTableOptions clearfixq">
		<div class="clearfixq">
			<form id="searchFrom">
				<input type="hidden" value="0" name="type" id="resumeType">
				<input type="hidden" value="0" name="favoriteId" id="favoriteId">
				<div id="apply_no_show">
					<input type="hidden" name="sex" id="sexHidden" value="0">
					<input type="hidden" name="sort" id="sortHidden" value="0">
					<input type="hidden" name="owner_id" id="ownerHidden" value="0">
					...
					<input type="hidden" name="educations" id="educationHidden" value="">
					...
					<div class="common_group w310 f_l mr_10 clearfixq pointer" id="jobfuctiontype">
						...
						<div class="centercon w264 clearfixq f_l">
							<span class="selected_con c_8c8c8c ellipsis pointer w183" id="jobfuctiontype_txt">全部岗位1</span>
							<span class="countnumber countnumber_hide t_r f_r" style="display: none;"></span>
						</div>
							...
							<div class="common_choose_layer clearfix">
								...
								<div class="w636 clearfix">
									...
									<div class="columns_chosebox relative clearfix">
											...
											<div class="chose_posttype_left" style="position:relative;">
												<div tabindex="0" class="scroll-pane clearfix jspScrollable" id="jobfuctiontype_dropdivleft_scroll" style="padding: 0px; width: 211px; height:360px; overflow-y: auto; overflow-x: hidden;" hidefocus="">
													<p class="posttype_level_one_all posttype_level_one_allcities clearfix">
														<span class="checkbox_txt checkbox_txt_checked bold">全部岗位1</span>
													</p>
										...
										<!-- 2 -->
										<div class="chose_posttype_right chose_center_wrap posttype_level_two_group clearfix" id="jobfuctiontype_dropdivcenter_wrap" style="display: none;">
										...
										<!-- 2 end -->
										<!-- 3 -->
										<div class="chose_right_wrap chose_right_items clearfix" id="jobfuctiontype_dropdivright_wrap" style="clear:none !important;display: none; overflow-x: hidden; overflow-y: auto;">
					...
					<div class="common_group w201 f_l mr_10 clearfixq pointer" id="tradetype">
						...
						<div class="centercon w155 clearfixq f_l">
							<span class="selected_con c_8c8c8c w74 ellipsis" id="tradetype_txt">全部岗位</span>
								...
								<div class="w420 clearfix">
									...
									<div class="columns_chosebox relative clearfix">
										...
										<div class="chose_left_wrap clearfix" id="tradetype_dropdivleft_wrap">
											<div class="chose_posttype_left" style="position:relative;">
												<div tabindex="0" class="scroll-pane clearfix jspScrollable" id="tradetype_dropdivleft_scroll" style="padding: 0px; width: 211px; height:360px; overflow-y: auto; overflow-x: hidden;" hidefocus="">
													<p class="posttype_level_one_all posttype_level_one_allcities clearfix">
										...
										<!-- 2 -->
										<div class="chose_right_wrap chose_right_items clearfix" id="tradetype_dropdivright_wrap" style="clear:none !important;display: none; overflow-x: hidden; overflow-y: auto;">
											<div id="tradetype_dropdivright_list">
												<?php if(is_array($job)): $i = 0; $__LIST__ = $job;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="hide clearfix" id="tradetype_dropdivrdiv_<?php echo ($val["id"]); ?>" v="<?php echo ($val["id"]); ?>" style="display: none;">
														<div class="clearfix">
							...
							<div class="common_choose_layer clearfix">
								...
								<div class="w310 clearfix">
									...
									<div class="clearfix">
										...
										<!-- 2 -->
										<div class="chose_posttype_right chose_citiestype_right posttype_level_two_box f_l chose_bgc_change" id="locationtype_dropdivright_wrap" style="clear:none !important;display: none; height:360px; overflow-x: hidden; overflow-y: auto;">
					...
					<div class="common_group w202 f_l mr_10 clearfixq pointer" id="education">
						...
						<div class="centercon w155 clearfixq f_l">
							<span class="selected_con c_8c8c8c w141 ellipsis" id="education_txt">全部学历</span>
							<span class="countnumber countnumber_hide t_r f_r"></span>
						</div>
						<em class="icon_deaultarrow f_r"></em>
						...
						<div class="common_choose_layer_wrapper w206 hide" style="display: none;">
							<div class="common_choose_layer clearfixq">
								...
								<div class="w202 clearfixq">
									<div class="all_level_box"><span class="checkbox_txt checkbox_txt_checked bold">全部学历</span></div>
									<div class="all_level_children">
										<ul class="clearfixq" id="xl_children">
										<?php if(is_array($educate)): $k = 0; $__LIST__ = $educate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k; if($v): ?><li class="clear">
													<span val="<?php echo ($k-1); ?>" class="checkbox_txt checkbox_txt_h28 <?php if(in_array($k-1,explode(',',$info['educations']))): ?>checkbox_txt_checked_h28<?php endif; ?>"><?php echo ($v); ?></span>
					...
					<div class="common_group w86 f_l mr_10 clearfixq pointer" id="sexlayer">
						<div class="centercon clearfixq f_l">
							<span class="selected_con c_8c8c8c ellipsis" id="sex_txt">全部性别</span>
						</div>
						<em class="icon_deaultarrow f_r"></em>
						<!-- common_choose_layer start -->
						<div class="common_choose_layer_wrapper w92" style="display: none;">
							<div class="common_choose_layer clearfixq">
								...
								<div class="w86 clearfixq">
									<div class="all_level_box"><span class="checkbox_txt checkbox_txt_checked">全部性别</span></div>
									<div class="all_level_children" id="sex_children">
										<ul class="clearfixq">
											<li class="clear"><span val="1" class="checkbox_txt checkbox_txt_h28">女</span></li>
											<li class="clear"><span val="2" class="checkbox_txt checkbox_txt_h28">男</span></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="common_group w135 f_l mr_10 clearfixq pointer" id="sortlayer">
						<div class="centercon clearfixq f_l">
							<span class="selected_con ellipsis c_8c8c8c" id="sort_txt">默认排序</span>
						</div>
						<em class="icon_deaultarrow f_r"></em>
						<!-- common_choose_layer start -->
						<div class="common_choose_layer_wrapper w140" style="display: none;">
							<div class="common_choose_layer clearfixq">
								<div class="common_choose_layer_arrow common_choose_layer_arrow02"></div>
								<div class="w135 clearfixq">
									<div class="all_level_box"><span class="checkbox_txt checkbox_txt_checked">全部排序</span></div>
									<div class="all_level_children" id="sort_children">
										<ul class="clearfixq">
											<li class="clear"><span val="0" class="checkbox_txt checkbox_txt_h28">默认排序</span></li>
											<li class="clear"><span val="1" class="checkbox_txt checkbox_txt_h28">按跟进时间排序</span></li>
											<li class="clear"><span val="2" class="checkbox_txt checkbox_txt_h28">按创建时间排序</span></li>
											<li class="clear"><span val="3" class="checkbox_txt checkbox_txt_h28">按更新时间排序</span></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="common_group w135 f_l mr_10 clearfixq pointer" id="ownerlayer">
						<div class="centercon clearfixq f_l">
							<span class="selected_con ellipsis c_8c8c8c" id="owner_txt">简历所有者</span>
						</div>
						<em class="icon_deaultarrow f_r"></em>
						<!-- common_choose_layer start -->
						<div class="common_choose_layer_wrapper w140" style="display: none;">
							<div class="common_choose_layer clearfixq">
								<div class="common_choose_layer_arrow common_choose_layer_arrow02"></div>
								<div class="w135 clearfixq">
									<div class="all_level_box"><span class="checkbox_txt checkbox_txt_checked">全部</span></div>
									<div class="all_level_children" id="owner_children">
										<ul class="clearfixq">
											<li class="clear"><span val="0" class="checkbox_txt checkbox_txt_h28">所有员工</span></li>
	
											<li class="clear"><span val="1" class="checkbox_txt checkbox_txt_h28">管理员</span></li>
	
											<li class="clear"><span val="2" class="checkbox_txt checkbox_txt_h28">财务</span></li>
	
											<li class="clear"><span val="3" class="checkbox_txt checkbox_txt_h28">总经理</span></li>
	
											<li class="clear"><span val="4" class="checkbox_txt checkbox_txt_h28">部门经理</span></li>
	
											<li class="clear"><span val="5" class="checkbox_txt checkbox_txt_h28">部门主管</span></li>
	
											<li class="clear"><span val="6" class="checkbox_txt checkbox_txt_h28">顾问</span></li>
	
											<li class="clear"><span val="7" class="checkbox_txt checkbox_txt_h28">助理顾问</span></li>
	
											<li class="clear"><span val="9" class="checkbox_txt checkbox_txt_h28">vg</span></li>
	
											<li class="clear"><span val="10" class="checkbox_txt checkbox_txt_h28">wz</span></li>
	
											<li class="clear"><span val="11" class="checkbox_txt checkbox_txt_h28">leon</span></li>
					...
					<div class="common_group w201 f_l mr_10 clearfixq pointer" id="flatype">
						<em class="icon_jobstype f_l icon_hy_ac"></em>
						<div class="centercon w155 clearfixq f_l">
							<span class="selected_con w74 ellipsis c_79c9ee" id="flatype_txt">自定义分类</span>
							<span class="countnumber countnumber_hide t_r f_r"></span>
						</div>
						<em class="icon_deaultarrow f_r"></em>
						<div class="common_choose_layer_wrapper w424" style="display: none;">
							<div class="common_choose_layer clearfix">
								...
								<div class="w420 clearfix">
									...
									<div class="columns_chosebox relative clearfix">
										<div class="tips_masklayer" id="flatype_dropdivright_tip" style="display: none;">
											<div class="bg"></div><span>选择分类</span></div>
										<div class="chose_left_wrap clearfix" id="flatype_dropdivleft_wrap">
											<div class="chose_posttype_left" style="position:relative;">
												<div tabindex="0" class="scroll-pane clearfix jspScrollable" id="flatype_dropdivleft_scroll" style="padding: 0px; width: 211px; height:360px; overflow-y: auto; overflow-x: hidden;" hidefocus="">
													<p class="posttype_level_one_all posttype_level_one_allcities clearfix">
														<span class="checkbox_txt checkbox_txt_checked bold">全部自定义分类</span>
													</p>
													<ul class="posttype_level_one type_level_one">
														...
														<li id="flatype_dropdivlli_2854" p="0" v="2854" class="">
														...
														<li id="flatype_dropdivlli_2857" p="0" v="2857" class="selected">
										...
										<!-- 2 -->
										<div class="chose_right_wrap chose_right_items clearfix" id="flatype_dropdivright_wrap" style="clear:none !important;overflow-x: hidden; overflow-y: auto; display: block;">
											<div id="flatype_dropdivright_list">
	
												<div class="hide clearfix" id="flatype_dropdivrdiv_2852" v="2852" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2852" v="2852" p="2852" title="全部状态">
															<span class="checkbox_txt">全部状态</span>
														</p>
														<ul class="chose_right_list">
	
															<li class="clear" id="flatype_classId_2891" title="xx" v="2891" p="2852">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2854" v="2854" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2854" v="2854" p="2854" title="全部已审核-待岗">
															<span class="checkbox_txt">全部已审核-待岗</span>
														</p>
														<ul class="chose_right_list">
	
															<li class="clear" id="flatype_classId_2859" title="1" v="2859" p="2854">
																<span class="checkbox_txt checkbox_txt_h28">1</span>
															</li>
	
															<li class="clear" id="flatype_classId_2860" title="2" v="2860" p="2854">
																<span class="checkbox_txt checkbox_txt_h28">2</span>
															</li>
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2855" v="2855" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2855" v="2855" p="2855" title="全部已预约">
															<span class="checkbox_txt">全部已预约</span>
														</p>
														<ul class="chose_right_list">
	
															<li class="clear" id="flatype_classId_2871" title="方式" v="2871" p="2855">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2856" v="2856" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2856" v="2856" p="2856" title="全部佳才已面试--待定">
															<span class="checkbox_txt">全部佳才已面试--待定</span>
														</p>
														<ul class="chose_right_list">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2857" v="2857" style="display: block;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2857" v="2857" p="2857" title="全部佳才已面试--推荐企业">
															<span class="checkbox_txt">全部佳才已面试--推荐企业</span>
														</p>
														<ul class="chose_right_list">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2858" v="2858" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2858" v="2858" p="2858" title="全部佳才已面试--推荐后待定">
															<span class="checkbox_txt">全部佳才已面试--推荐后待定</span>
														</p>
														<ul class="chose_right_list">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2861" v="2861" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2861" v="2861" p="2861" title="全部88">
															<span class="checkbox_txt">全部88</span>
														</p>
														<ul class="chose_right_list">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2863" v="2863" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2863" v="2863" p="2863" title="全部上班状态">
															<span class="checkbox_txt">全部上班状态</span>
														</p>
														<ul class="chose_right_list">
	
															<li class="clear" id="flatype_classId_2864" title="上班了" v="2864" p="2863">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2872" v="2872" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2872" v="2872" p="2872" title="全部1111111">
															<span class="checkbox_txt">全部1111111</span>
														</p>
														<ul class="chose_right_list">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2873" v="2873" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2873" v="2873" p="2873" title="全部qq">
															<span class="checkbox_txt">全部qq</span>
														</p>
														<ul class="chose_right_list">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2874" v="2874" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2874" v="2874" p="2874" title="全部证书">
															<span class="checkbox_txt">全部证书</span>
														</p>
														<ul class="chose_right_list">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2875" v="2875" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2875" v="2875" p="2875" title="全部到期时间">
															<span class="checkbox_txt">全部到期时间</span>
														</p>
														<ul class="chose_right_list">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2892" v="2892" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2892" v="2892" p="2892" title="全部xxx">
															<span class="checkbox_txt">全部xxx</span>
														</p>
														<ul class="chose_right_list">
												...
												<div class="hide clearfix" id="flatype_dropdivrdiv_2893" v="2893" style="display: none;">
													<div class="clearfix">
														<p class="chose_right_all clearfix" id="flatype_classId_2893" v="2893" p="2893" title="全部xxxxx">
															<span class="checkbox_txt">全部xxxxx</span>
														</p>
														<ul class="chose_right_list">
				...
				<!-- apply_no_show finished -->
				<div class="common_group w92 f_l mr_10 relative clearfixq" id="txtResumeNo_div">
					<input class="common_keywordsinput c_8c8c8c f_l" id="txtResumeNo" name="no" style="width:72px;" type="text" value="简历编号">
				</div>
				<div class="common_group w70 f_l mr_10 relative clearfixq" id="txtAgemin_div">
					<input class="common_keywordsinput c_8c8c8c f_l" id="agemin" name="agemin" style="width:50px;" maxlength="2" type="text" value="最小年龄">
				</div>
				<div class="common_group w70 f_l mr_10 relative clearfixq" id="txtAgemax_div">
					<input class="common_keywordsinput c_8c8c8c f_l" id="agemax" name="agemax" style="width:50px;" maxlength="2" type="text" value="最大年龄">
				</div>
				<div class="common_group f_l mr_10 relative clearfixq" style="width:250px;" id="txtKeyWords_div">
					<input class="common_keywordsinput c_8c8c8c" style="width:130px;" name="keyword" id="resumeSearchKeyword" type="text" value="输入简历关键字">
					<div style="padding:5px 8px 0 145px; float: left;">
						<label><input type="radio" name="keyAccurate" value="1" checked="">精确</label>
						<label><input type="radio" name="keyAccurate" value="0">模糊</label>
					</div>
					<em class="icon_deaultarrow f_r" style="cursor: pointer;" id="keywordFieldSelectBtn" title="选择查询字段与设定不同字段的关键字"></em>
					<!-- common_choose_layer start -->
					<div class="common_choose_layer_wrapper" style="width:250px; display:none;" id="keywordFieldSelectDiv">
						<div class="common_choose_layer clearfixq">
							<div class="common_choose_layer_arrow common_choose_layer_arrow02"></div>
							<div class="clearfixq">
								<div class="all_level_children">
									<div class="all_level_box">
										选择查询字段与关键字
										<div class="new_okbtn_box f_r">
											<a class="new_commonbtn_02" href="javascript:;" onclick="$('#keywordFieldSelectDiv').hide();">确定</a>
										</div>
									</div>
									<ul class="clearfixq">
										<li class="clear"><label><input type="checkbox" name="keywordFields" value="name" checked="checked"> 姓名</label></li>
										<li class="clear"><label><input type="checkbox" name="keywordFields" value="contact" checked="checked"> 联系方式</label></li>
										<li class="clear"><label><input type="checkbox" name="keywordFields" value="email" checked="checked"> 邮箱</label></li>
										<li class="clear"><label><input type="checkbox" name="keywordFields" value="tags" checked="checked"> 自定义标签</label> <span style="float:right; margin-right:3px; color:green;">关键字：<input type="text" name="tagsKeyword" value="" style="width:80px; border: 1px solid #666; padding:0px; height:16px;"></span></li>
										<li class="clear"><label><input type="checkbox" name="keywordFields" value="content" checked="checked"> 简历内容</label></li>
										<li class="clear"><label><input type="checkbox" name="keywordFields" value="curCompany" checked="checked"> 当前公司</label> <span style="float:right; margin-right:3px; color:green;">关键字：<input type="text" name="curCompanyKeyword" value="" style="width:80px; border: 1px solid #666; padding:0px; height:16px;"></span></li>
									</ul>
								</div>
							</div>
						</div>
				...
				<a href="javascript:;" style="float:left;margin-top:10px;" id="keyHelp" original-title="关键字可以搜索：<br></a><font style='color:#f00;'>姓名/联系方式/联系邮箱/自定义标签/当前公司/简历内容</font><br/>如果要同时满足多个词，请用空格分隔，如多个词只需满足一个，请用|分隔。如：建筑 总经理|施工员 相当于筛选:(建筑 总经理)或者(建筑 施工员)<br/><font style='color:#f00;'>如需完全匹配某字符串，不想让系统自动分词，请用引号包含该字符串，如：&quot;财务总监&quot;</font>"><img src="../../images/help.gif"></a>&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" id="searchFromBtn" class="searchButton" style="float:left; cursor: pointer; height:35px;" value=" 查询 ">
			</form>
		</div>
	</div>
	<!-- 
		<div title="自定义显示栏位" id="resuFieldBtn" style="position: absolute;left:-2px; cursor: pointer; padding:16px; background:url(/images/settings-32.png) 0 0 no-repeat;"></div>
		 -->
	<div id="listpage" style="min-height:500px;">

		<input type="hidden" id="keywordencode" value="">
		<table width="100%" class="sTable2" cellspacing="0" cellpadding="0">
			<thead>
				<tr>
					<td width="50" style="min-width:24px;" align="center">编号</td>
					<td>姓名</td>

					<td width="80">地区</td>
					<td width="140">当前公司</td>

					<td width="25">性别</td>
					<td width="25">学历</td>
					<td width="90">自定义分类</td>
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
					...
					<td style="min-width:200px;">
						<a href="javascript:;"  class="J_showdialog" style="color: #069;"  data-uri="<?php echo U('resume/detail', array('id'=>$val['id']));?>" data-title="<?php echo ($val["resuname"]); ?>" data-id="resume_detail" data-width="1200" data-height="500"><?php echo ($val["resuname"]); if($val['type'] == 0): ?><span style="color: green;font-size: 12px;">(未完善)</span><?php endif; ?></a>
					...
					<td>
						...
						<a href="javascript:;"   style="color: #069;cursor:pointer;"    class="J_showdialog" data-uri="<?php echo U('Resume/edit',array('id'=>$val['id']));?>" data-title="编辑简历" data-id="edit" data-editor="1" data-width="783" data-height="500">编辑</a>
	
						<a href="javascript:void(0);" style="color: #069;cursor:pointer;" class="J_confirmurl" data-uri="<?php echo u('resume/delete', array('id'=>$val['id']));?>" data-acttype="ajax" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['title']);?>"><?php echo L('delete');?></a></td>
