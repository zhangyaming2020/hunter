...
<title><?php echo L('website_manage');?></title>
	...
	var URL = '/hunter/jradmin.php/Depart';

	var SELF = '/hunter/jradmin.php?m=Admin&c=depart&a=index&menuid=552';
...
<a href="javascript:;" class="J_showdialog btn" style="color:#fff;" data-uri="<?php echo U('depart/add',array('id'=>0));?>" data-title="添加"  data-id="add" data-width="500" data-height="60">添加</a>
