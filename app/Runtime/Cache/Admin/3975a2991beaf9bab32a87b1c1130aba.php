...
<div class="dialog_content form_default"  style="padding:0; height:458px; OVERFLOW-Y: auto; BORDER: #ccc 1px solid;">
	<form id="info_form" name="info_form" action="<?php echo U('resume/edit');?>" method="post">
	<body style="background:#fff;padding:10px;">
			<table border="0" cellpaddin海g="0" style="margin-top:20px;" cellspacing="0" width="100%" class="rTable" align="left">
				...
				<input type="hidden" name="trades" id="tradeHidden" value="<?php echo ($info["trades"]); ?>">
				<input type="hidden" name="locations" id="locationHidden" value="<?php echo ($info["locations"]); ?>">
				<input type="hidden" name="educations" id="educationHidden" value="<?php echo ($info["educations"]); ?>">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<div class="common_group w194 f_l mr_10 relative clearfixq" id="resuName_div">
								<input class="common_keywordsinput c_8c8c8c w183 f_l" name="resuName" id="resuName" type="text" value="<?php if($info['resuname']): echo ($info["resuname"]); else: ?>姓名<?php endif; ?>">
							</div>
							<div class="common_group w201 f_l mr_10 clearfixq pointer" id="locationtype">
								...
								<div class="centercon w155 clearfixq f_l">
									<span class="selected_con c_8c8c8c ellipsis pointer w70" id="locationtype_txt"><?php if($info['locations']): echo ($info["locations_name"]); else: ?>意向地区<?php endif; ?></span>
								...
								<div class="common_choose_layer_wrapper w314" style="display: none;">
									<div class="common_choose_layer clearfix">
										...
										<div class="w310 clearfix">
											<div class="selected_group_box clearfix" id="locationtype_dropdivselected_div" style="display: ;">
							...
							<div class="common_group w202 f_l mr_10 clearfixq pointer" id="education">
								...
								<div class="centercon w155 clearfixq f_l">
									<span class="selected_con c_8c8c8c w141 ellipsis" id="education_txt"><?php echo ($info['edu_name']); ?></span>
									<span class="countnumber countnumber_hide t_r f_r"></span>
								</div>
								<em class="icon_deaultarrow f_r"></em>
							...
							<div class="common_group w86 f_l mr_10 clearfixq pointer" id="sexlayer">
								<div class="centercon clearfixq f_l">
									<span class="selected_con c_8c8c8c ellipsis" id="sex_txt"><?php if($info['sex'] == 1): ?>男<?php elseif($info['sex'] == 0): ?>女<?php else: ?>性别<?php endif; ?></span>
								</div>
								<em class="icon_deaultarrow f_r"></em>
								<!-- common_choose_layer start -->
									...
									<div class="common_choose_layer clearfixq">
										...
										<div class="w86 clearfixq">
											<div class="all_level_children" id="sex_children">
												<ul class="clearfixq">
													<li class="clear"><span val="0" class="checkbox_txt checkbox_txt_h28 <?php if($info['sex'] == 0): ?>checkbox_txt_checked_h28<?php endif; ?>">女</span></li>
													<li class="clear"><span val="1" class="checkbox_txt checkbox_txt_h28 <?php if($info['sex'] == 1): ?>checkbox_txt_checked_h28<?php endif; ?>">男</span></li>
												</ul>
											</div>
										</div>
									</div>
							...
							<div class="common_group w201 f_l mr_10 clearfixq pointer" id="tradetype">
								...
								<div class="centercon w155 clearfixq f_l">
									<span class="selected_con c_8c8c8c w74 ellipsis" id="tradetype_txt"><?php if($info['trades']): echo ($info["trades_name"]); else: ?>所属行业<?php endif; ?></span>
									<span class="countnumber countnumber_hide t_r f_r"></span>
								</div>
								<em class="icon_deaultarrow f_r"></em>
					...
					<tr>
						...
						<td>
							...
							<div class="common_group f_l mr_10 relative clearfixq" id="resuEmail_div" style="width:300px">
								<input class="common_keywordsinput c_8c8c8c f_l" name="resuEmail" id="resuEmail" type="text" value="<?php if($info['resuemail']): echo ($info["resuemail"]); else: ?>联系邮箱<?php endif; ?>" style="width:255px"> &nbsp;
					...
					<tr>
						...
						<td>
							...
							<div class="common_group w194 f_l mr_10 relative clearfixq" id="resuContactInfo_div" style="width:405px;">
								<input class="common_keywordsinput c_8c8c8c f_l w183" name="resuContactInfo" id="resuContactInfo" style="width:90%;" type="text" value="<?php if($info['resucontactinfo']): echo ($info["resucontactinfo"]); else: ?>联系方式<?php endif; ?>"> &nbsp;
					...
					<tr>
						...
						<td>
							...
							<textarea name="info" style="width:628px;height:511px;" class="info" ><?php echo code2html($info['info']);?></textarea>
						</td>
					</tr>
