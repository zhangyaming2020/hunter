$(function(){
    ...
    $(function(){
        var div = '\
        <div id="key" style="position:absolute;background-color:#A8A8A8;width:99.5%;bottom:0px; right:-100%; z-index:2">\
            <ul id="keyboard" style="font-size:20px;margin:2px -2px 1px 2px">\
                ...
                <li class="cancle btn_number_  quxiaopay">取消</li>\
            </ul>\
        </div>\
        ';
        
        $('.cancle btn_number_').click(function(){
        	$('#password').find('input').val('');
        })
//      $('.quxiaopay').click(function(){
//	$('#key').animate({'right':'-100%'},100);
//	$('.board').animate({'left':'100%'},100);
//	$('.pay_tc').css('display','none')
//	
//})
